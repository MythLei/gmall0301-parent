...
public class DwdTradeRefundPaySuc {
    public static void main(String[] args) {
        ...
        tableEnv.executeSql(MyKafkaUtil.getTopicDDL("dwd_trade_refund_suc_group"));

        //TODO 4.过滤出退款表中退款成功数据
